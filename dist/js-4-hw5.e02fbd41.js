...
document.addEventListener("keydown", (event)=>{
    ...
    if (pressed === expected) {
        ...
        if (currentKeyIndex >= keys.length) {
            (0, _core.success)({
                text: "\u0413\u0440\u0443 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043E! \u0412\u0438 \u043D\u0430\u0442\u0438\u0441\u043D\u0443\u043B\u0438 \u0432\u0441\u0456 \u043A\u043B\u0430\u0432\u0456\u0448\u0456 \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E."
            });
            keyDisplay.textContent = "\u0413\u0440\u0443 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043E!";
        } else {
            keyDisplay.textContent = keys[currentKeyIndex];
            (0, _core.success)({
                text: "\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E! \u0419\u0434\u0435\u043C\u043E \u0434\u0430\u043B\u0456."
            });
        }
    } else (0, _core.error)({
        text: `\u{41F}\u{43E}\u{43C}\u{438}\u{43B}\u{43A}\u{430}! \u{41E}\u{447}\u{456}\u{43A}\u{443}\u{454}\u{442}\u{44C}\u{441}\u{44F}: ${expected}, \u{430} \u{432}\u{438} \u{43D}\u{430}\u{442}\u{438}\u{441}\u{43D}\u{443}\u{43B}\u{438}: ${pressed}`
    });
});
